...
class SimpleCarWorld(World):
    COLLISION_PENALTY = 35 * 1e0  # выберите сами
    HEADING_REWARD = 35 * 1e-1  # выберите сами
    WRONG_HEADING_PENALTY = 35 * 1e0  # выберите сами
    IDLENESS_PENALTY = 35 * 1e-1  # выберите сами
...
if __name__ == "__main__":
    ...
    # agent = SimpleCarAgent.from_file('network_config_agent_0_layers_9_1')
    # # создаёт мир
